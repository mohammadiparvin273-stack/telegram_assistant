...
همه‌ی تاریخ‌ها رو به شمسی نشونت می‌دم و هر جوری که راحتی می‌تونی زمان رو بگی (مثلا «فردا ساعت ۹» یا «1405/05/10 14:00»).
...
🗂 یادآوری و برنامه
/remind زمان + متن   ثبت یادآوری (هر فرمتی: «فردا ساعت ۹ تماس با علی» یا «1405/05/10 14:00 جلسه»)
/reminders   لیست یادآوری‌های فعال (شمسی)
/delreminder ID   حذف یادآوری
/event زمان + عنوان   ثبت رویداد/قرار
...
/deltask ID   حذف کار
/goal عنوان | ددلاین(اختیاری) | توضیح   ثبت هدف
/goals   لیست اهداف
/delgoal ID   حذف هدف
...
نکته: لازم نیست فرمت خاصی رو رعایت کنی، هر جوری که راحتی بنویس، من خودم می‌فهمم."""
...
async def subscribe_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_access_allowed(chat_id):
        await update.message.reply_text(_subscription_status_text(user))
        return
